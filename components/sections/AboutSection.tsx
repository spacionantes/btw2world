...
export default function AboutSection() {
  ...
  return (
    <div ref={ref} style={{ marginTop: '-64px', position: 'relative', zIndex: 10 }}>
      <motion.section style={{ y, borderRadius: radius, background: '#354f3b', boxShadow: '0 -40px 120px rgba(0,0,0,0.55)' }}>
        <div className="grid-2col" style={{ minHeight: '90vh' }}>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.97 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, amount: 0.1 }} transition={{ duration: 1.2, delay: 0.15 }}
            ...
            <div style={{ position: 'absolute', top: '32px', left: '32px', background: 'rgba(246,183,77,0.88)', color: '#354f3b', fontFamily: J, fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.2em', padding: '7px 16px', fontWeight: 500 }}>
              Guide & Photographe
            </div>
